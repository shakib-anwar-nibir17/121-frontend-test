...
export default function ShopApplyForm({ setStep }) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="w-full">
      <div className="mb-6">
        <label
          htmlFor="shop_name"
          className="text-black inline-block mb-3 font-normal"
        >
          Shop Name*
        </label>
        <div
      ...
      <div className="mb-6">
        ...
        <div>
          <p className="text-lg font-lg mb-2 text-black mt-2">
      ...
      <div className="mb-6">
        ...
        >
          <textarea
            {...register("address")}
            className="py-3 px-4 w-full focus:outline-none h-28"
            id="address"
            type="text"
      ...
      <Button
        type="submit"
        className="py-3 w-full  rounded-lg mb-3 xl:mt-6 mt-2"
      >
        Apply for eshop
      </Button>
    </form>
